      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button type="button" onClick={() => set("purpose", "BREEDING")} className={chip(form.purpose === "BREEDING", "green")}>
              {t("form_forBreeding")}
            </button>
            <button type="button" onClick={() => set("purpose", "ADOPT")} className={chip(form.purpose === "ADOPT", "purple")}>
              {t("form_forAdopt")}
            </button>
          </div>
        </div>
